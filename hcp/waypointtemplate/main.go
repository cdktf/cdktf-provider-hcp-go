...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.waypointTemplate.WaypointTemplateConfig",
		reflect.TypeOf((*WaypointTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.waypointTemplate.WaypointTemplateTerraformCloudWorkspaceDetails",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.waypointTemplate.WaypointTemplateTerraformNoCodeModule",
		reflect.TypeOf((*WaypointTemplateTerraformNoCodeModule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.waypointTemplate.WaypointTemplateTerraformNoCodeModuleOutputReference",
		reflect.TypeOf((*WaypointTemplateTerraformNoCodeModuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_WaypointTemplateTerraformNoCodeModuleOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.waypointTemplate.WaypointTemplateVariableOptions",
		reflect.TypeOf((*WaypointTemplateVariableOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.waypointTemplate.WaypointTemplateVariableOptionsList",
