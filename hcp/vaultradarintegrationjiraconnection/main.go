...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultRadarIntegrationJiraConnection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.vaultRadarIntegrationJiraConnection.VaultRadarIntegrationJiraConnectionConfig",
		reflect.TypeOf((*VaultRadarIntegrationJiraConnectionConfig)(nil)).Elem(),
	)
}
