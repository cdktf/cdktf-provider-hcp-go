...
func (v *jsiiProxy_VaultSecretsSecret) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (v *jsiiProxy_VaultSecretsSecret) validateImportFromParameters(id *string) error {
	return nil
}
...
func (v *jsiiProxy_VaultSecretsSecret) validateMoveFromIdParameters(id *string) error {
	return nil
}

func (v *jsiiProxy_VaultSecretsSecret) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (v *jsiiProxy_VaultSecretsSecret) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateVaultSecretsSecret_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func (j *jsiiProxy_VaultSecretsSecret) validateSetProjectIdParameters(val *string) error {
	return nil
}
