...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultSecretsSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.vaultSecretsSecret.VaultSecretsSecretConfig",
		reflect.TypeOf((*VaultSecretsSecretConfig)(nil)).Elem(),
	)
}
