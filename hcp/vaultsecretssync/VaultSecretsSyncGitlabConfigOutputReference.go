...
func (j *jsiiProxy_VaultSecretsSyncGitlabConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewVaultSecretsSyncGitlabConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VaultSecretsSyncGitlabConfigOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-hcp.vaultSecretsSync.VaultSecretsSyncGitlabConfigOutputReference",
...
func NewVaultSecretsSyncGitlabConfigOutputReference_Override(v VaultSecretsSyncGitlabConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_VaultSecretsSyncGitlabConfigOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (v *jsiiProxy_VaultSecretsSyncGitlabConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VaultSecretsSyncGitlabConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (v *jsiiProxy_VaultSecretsSyncGitlabConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VaultSecretsSyncGitlabConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
