...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultRadarIntegrationSlackSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.vaultRadarIntegrationSlackSubscription.VaultRadarIntegrationSlackSubscriptionConfig",
		reflect.TypeOf((*VaultRadarIntegrationSlackSubscriptionConfig)(nil)).Elem(),
	)
}
