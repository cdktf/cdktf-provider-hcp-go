...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "destinationCidrInput", GoGetter: "DestinationCidrInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hvnRouteId", GoGetter: "HvnRouteId"},
			_jsii_.MemberProperty{JsiiProperty: "hvnRouteIdInput", GoGetter: "HvnRouteIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetLink", GoGetter: "TargetLink"},
			_jsii_.MemberProperty{JsiiProperty: "targetLinkInput", GoGetter: "TargetLinkInput"},
