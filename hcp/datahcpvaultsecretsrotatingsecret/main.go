...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataHcpVaultSecretsRotatingSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.dataHcpVaultSecretsRotatingSecret.DataHcpVaultSecretsRotatingSecretConfig",
		reflect.TypeOf((*DataHcpVaultSecretsRotatingSecretConfig)(nil)).Elem(),
	)
}
