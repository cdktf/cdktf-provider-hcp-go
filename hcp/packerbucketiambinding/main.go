...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PackerBucketIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.packerBucketIamBinding.PackerBucketIamBindingConfig",
		reflect.TypeOf((*PackerBucketIamBindingConfig)(nil)).Elem(),
	)
}
