...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "accessKeysInput", GoGetter: "AccessKeysInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAccessKeys", GoMethod: "PutAccessKeys"},
			_jsii_.MemberMethod{JsiiMethod: "putFederatedWorkloadIdentity", GoMethod: "PutFederatedWorkloadIdentity"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccessKeys", GoMethod: "ResetAccessKeys"},
