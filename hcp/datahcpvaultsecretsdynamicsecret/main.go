...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataHcpVaultSecretsDynamicSecret)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.dataHcpVaultSecretsDynamicSecret.DataHcpVaultSecretsDynamicSecretConfig",
		reflect.TypeOf((*DataHcpVaultSecretsDynamicSecretConfig)(nil)).Elem(),
	)
}
