...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataHcpPackerVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.dataHcpPackerVersion.DataHcpPackerVersionConfig",
		reflect.TypeOf((*DataHcpPackerVersionConfig)(nil)).Elem(),
	)
}
