...
import (
	...
	"github.com/cdktf/cdktf-provider-hcp-go/hcp/v10/project/internal"
...
func (j *jsiiProxy_Project) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
func (j *jsiiProxy_Project) ResourceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceName",
...
func NewProject(scope constructs.Construct, id *string, config *ProjectConfig) Project {
	...
	_jsii_.Create(
		"@cdktf/provider-hcp.project.Project",
