...
func (p *jsiiProxy_PackerChannelAssignment) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PackerChannelAssignment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PackerChannelAssignment) ToHclTerraform() interface{} {
	var returns interface{}
