...
func (w *jsiiProxy_WaypointAddOnDefinitionVariableOptionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WaypointAddOnDefinitionVariableOptionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
