...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultClusterAdminToken)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VaultClusterAdminTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.vaultClusterAdminToken.VaultClusterAdminTokenTimeouts",
		reflect.TypeOf((*VaultClusterAdminTokenTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.vaultClusterAdminToken.VaultClusterAdminTokenTimeoutsOutputReference",
		reflect.TypeOf((*VaultClusterAdminTokenTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
