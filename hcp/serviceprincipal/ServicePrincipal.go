...
import (
	...
	"github.com/cdktf/cdktf-provider-hcp-go/hcp/v10/serviceprincipal/internal"
...
func (j *jsiiProxy_ServicePrincipal) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ServicePrincipal) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ServicePrincipal) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_ServicePrincipal) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_ServicePrincipal) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
func (j *jsiiProxy_ServicePrincipal) ResourceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceName",
...
func NewServicePrincipal(scope constructs.Construct, id *string, config *ServicePrincipalConfig) ServicePrincipal {
	...
	_jsii_.Create(
		"@cdktf/provider-hcp.servicePrincipal.ServicePrincipal",
...
func (j *jsiiProxy_ServicePrincipal)SetName(val *string) {
...
func (j *jsiiProxy_ServicePrincipal)SetParent(val *string) {
...
func (s *jsiiProxy_ServicePrincipal) ResetParent() {
	_jsii_.InvokeVoid(
		s,
		"resetParent",
		nil, // no parameters
