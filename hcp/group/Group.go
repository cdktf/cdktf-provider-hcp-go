...
import (
	...
	"github.com/cdktf/cdktf-provider-hcp-go/hcp/v10/group/internal"
...
func (j *jsiiProxy_Group) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
func (j *jsiiProxy_Group) ResourceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceName",
...
func NewGroup(scope constructs.Construct, id *string, config *GroupConfig) Group {
	...
	_jsii_.Create(
		"@cdktf/provider-hcp.group.Group",
