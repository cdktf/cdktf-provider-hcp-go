...
func (j *jsiiProxy_WaypointAddOnOutputValuesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WaypointAddOnOutputValuesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_WaypointAddOnOutputValuesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_WaypointAddOnOutputValuesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_WaypointAddOnOutputValuesList)SetWrapsSet(val *bool) {
...
func (w *jsiiProxy_WaypointAddOnOutputValuesList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WaypointAddOnOutputValuesList) Get(index *float64) WaypointAddOnOutputValuesOutputReference {
	if err := w.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns WaypointAddOnOutputValuesOutputReference
...
func (w *jsiiProxy_WaypointAddOnOutputValuesList) ToString() *string {
	var returns *string
