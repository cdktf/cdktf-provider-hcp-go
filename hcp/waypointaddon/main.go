...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "addOnDefinitionInputVariables", GoGetter: "AddOnDefinitionInputVariables"},
			_jsii_.MemberProperty{JsiiProperty: "addOnInputVariables", GoGetter: "AddOnInputVariables"},
			_jsii_.MemberProperty{JsiiProperty: "addOnInputVariablesInput", GoGetter: "AddOnInputVariablesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "definitionIdInput", GoGetter: "DefinitionIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAddOnInputVariables", GoMethod: "PutAddOnInputVariables"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "readmeMarkdown", GoGetter: "ReadmeMarkdown"},
			_jsii_.MemberMethod{JsiiMethod: "resetAddOnInputVariables", GoMethod: "ResetAddOnInputVariables"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.waypointAddOn.WaypointAddOnTerraformNoCodeModule",
		reflect.TypeOf((*WaypointAddOnTerraformNoCodeModule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.waypointAddOn.WaypointAddOnTerraformNoCodeModuleOutputReference",
		reflect.TypeOf((*WaypointAddOnTerraformNoCodeModuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
