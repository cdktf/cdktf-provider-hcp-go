...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultSecretsAppIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.vaultSecretsAppIamPolicy.VaultSecretsAppIamPolicyConfig",
		reflect.TypeOf((*VaultSecretsAppIamPolicyConfig)(nil)).Elem(),
	)
}
