...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultRadarIntegrationSlackConnection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.vaultRadarIntegrationSlackConnection.VaultRadarIntegrationSlackConnectionConfig",
		reflect.TypeOf((*VaultRadarIntegrationSlackConnectionConfig)(nil)).Elem(),
	)
}
