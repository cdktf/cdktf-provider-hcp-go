...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IamWorkloadIdentityProvider)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "conditionalAccess", GoGetter: "ConditionalAccess"},
			_jsii_.MemberProperty{JsiiProperty: "conditionalAccessInput", GoGetter: "ConditionalAccessInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.iamWorkloadIdentityProvider.IamWorkloadIdentityProviderAws",
		reflect.TypeOf((*IamWorkloadIdentityProviderAws)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.iamWorkloadIdentityProvider.IamWorkloadIdentityProviderAwsOutputReference",
		reflect.TypeOf((*IamWorkloadIdentityProviderAwsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.iamWorkloadIdentityProvider.IamWorkloadIdentityProviderConfig",
		reflect.TypeOf((*IamWorkloadIdentityProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.iamWorkloadIdentityProvider.IamWorkloadIdentityProviderOidc",
		reflect.TypeOf((*IamWorkloadIdentityProviderOidc)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.iamWorkloadIdentityProvider.IamWorkloadIdentityProviderOidcOutputReference",
		reflect.TypeOf((*IamWorkloadIdentityProviderOidcOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
