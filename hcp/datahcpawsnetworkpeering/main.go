...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataHcpAwsNetworkPeering)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "peerVpcRegion", GoGetter: "PeerVpcRegion"},
			_jsii_.MemberProperty{JsiiProperty: "projectId", GoGetter: "ProjectId"},
			_jsii_.MemberProperty{JsiiProperty: "projectIdInput", GoGetter: "ProjectIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "providerPeeringId", GoGetter: "ProviderPeeringId"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.dataHcpAwsNetworkPeering.DataHcpAwsNetworkPeeringConfig",
		reflect.TypeOf((*DataHcpAwsNetworkPeeringConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.dataHcpAwsNetworkPeering.DataHcpAwsNetworkPeeringTimeouts",
		reflect.TypeOf((*DataHcpAwsNetworkPeeringTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-hcp.dataHcpAwsNetworkPeering.DataHcpAwsNetworkPeeringTimeoutsOutputReference",
		reflect.TypeOf((*DataHcpAwsNetworkPeeringTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
