...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VaultSecretsAppIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-hcp.vaultSecretsAppIamBinding.VaultSecretsAppIamBindingConfig",
		reflect.TypeOf((*VaultSecretsAppIamBindingConfig)(nil)).Elem(),
	)
}
