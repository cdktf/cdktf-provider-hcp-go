...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authTokenTimeToLiveInput", GoGetter: "AuthTokenTimeToLiveInput"},
			_jsii_.MemberProperty{JsiiProperty: "authTokenTimeToStale", GoGetter: "AuthTokenTimeToStale"},
			_jsii_.MemberProperty{JsiiProperty: "authTokenTimeToStaleInput", GoGetter: "AuthTokenTimeToStaleInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maintenanceWindowConfig", GoGetter: "MaintenanceWindowConfig"},
			_jsii_.MemberProperty{JsiiProperty: "maintenanceWindowConfigInput", GoGetter: "MaintenanceWindowConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putMaintenanceWindowConfig", GoMethod: "PutMaintenanceWindowConfig"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAuthTokenTimeToLive", GoMethod: "ResetAuthTokenTimeToLive"},
			_jsii_.MemberMethod{JsiiMethod: "resetAuthTokenTimeToStale", GoMethod: "ResetAuthTokenTimeToStale"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaintenanceWindowConfig", GoMethod: "ResetMaintenanceWindowConfig"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUpgradeType", GoMethod: "ResetUpgradeType"},
