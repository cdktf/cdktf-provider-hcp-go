...
func (b *jsiiProxy_BoundaryClusterMaintenanceWindowConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BoundaryClusterMaintenanceWindowConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
