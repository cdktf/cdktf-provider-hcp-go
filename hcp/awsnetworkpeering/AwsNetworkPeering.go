...
func (j *jsiiProxy_AwsNetworkPeering) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_AwsNetworkPeering) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_AwsNetworkPeering) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AwsNetworkPeering) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func NewAwsNetworkPeering(scope constructs.Construct, id *string, config *AwsNetworkPeeringConfig) AwsNetworkPeering {
	...
	_jsii_.Create(
		"@cdktf/provider-hcp.awsNetworkPeering.AwsNetworkPeering",
...
func (j *jsiiProxy_AwsNetworkPeering)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AwsNetworkPeering)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AwsNetworkPeering)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AwsNetworkPeering_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AwsNetworkPeering) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AwsNetworkPeering) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AwsNetworkPeering) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
