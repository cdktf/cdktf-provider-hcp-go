...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSplunkCloud", GoMethod: "PutSplunkCloud"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloudwatch", GoMethod: "ResetCloudwatch"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSplunkCloud", GoMethod: "ResetSplunkCloud"},
			_jsii_.MemberProperty{JsiiProperty: "splunkCloud", GoGetter: "SplunkCloud"},
			_jsii_.MemberProperty{JsiiProperty: "splunkCloudInput", GoGetter: "SplunkCloudInput"},
			_jsii_.MemberProperty{JsiiProperty: "streamingDestinationId", GoGetter: "StreamingDestinationId"},
